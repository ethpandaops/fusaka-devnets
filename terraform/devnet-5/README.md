# Devnet-5 Configuration

## Overview
Devnet-5 consists of 1500 nodes distributed across DigitalOcean and Hetzner cloud providers with a specific client distribution to test network diversity.
...
*Note: NimbusEL has been removed from devnet-5.*
